...
{
    //UN COCHE PODRA GIRAR, ASI QUE NOS CREAMOS UNA ENUMERACION PARA LA DIRECCION DEL COCHE
    ...
    public class Coche
    {
        ...
        //POR LO QUE NO VA A SER UNA PROPIEDAD QUE EL CONDUCTOR PUEDA CAMBIAR (PROGRAM)
        private int VelocidadMaxima;

        //VAMOS A CREAR UNA VARIABLE QUE NOS INDICARA SI EL COCHE ESTA ARRANCADO/DETENIDO
        private bool EstadoArranque;

        //VAMOS A CREAR DOS CONSTRUCTORES UN CONSTRUCTOR DE UN COCHE CON A VELOCIDAD MAXIMA PREDEFINIDA
        public Coche()
        {
        ...
        //CREAMOS UN CONSTRUCTOR PARA QUE NOS INDIQUEN LA VELOCIDAD MAXIMA DE UN COCHE 
        ...
        //EN EL METODO toString() VAMOS A DEVOLVER UN STRING CON CARACTERISTICAS DEL COCHE
        public override string ToString()
        {
            return this.Marca + " " + this.Modelo + ", Velocidad: " + this.VelocidadActual + ", Direccion: " + this.DireccionCoche;
        }
